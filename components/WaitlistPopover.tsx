    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-center space-x-2">
          <Image
            src={
              isDarkMode ? `/img/supabase-dark.svg` : `/img/supabase-light.svg`
            }
            alt="supabase"
            height={20}
            width={100}
          ...
          >
            <p
              className={`transition-all text-scale-900 text-sm ${
            ...
            <p
              className={`transition-all text-scale-1200 text-sm ${
                isExpanded ? "-ml-2" : "ml-0"
              }`}
            >
              Realtime
      ...
      <div className="space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-scale-900">
            Realtime collaborative app to display broadcast, presence, and
            database listening over WebSockets
          </p>
        </div>
        <div>
          <a
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            passHref
          >
            <Button as="a" type="secondary" icon={<IconTwitter />}>
              Invite on Twitter
            </Button>
          </Link>
        </div>
